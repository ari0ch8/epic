...
#define SOURCE_GRAPHICS_WIDTH	1024
// TODO: implement source graphics height
#define PI						3.14159f
...
class GameApp : public SexyAppBase
{
	...
	public:
		...
		// monkey
		std::ofstream	mMonkeyFile;
		bool			isMonkeyingAllLevels;

		float			mMusicFadeInTimer;
...
//		std::fstream	debugStream;
		...
		//////////////////////////////////////////////////////////////////////////
		//	Function: GameScreenIsFinished
		//	Parameters: none
		//	Returns: none
		//
		//	Purpose: Called by the GameScreen widget when it is about to close
		//	down, this indicates that we should now add the board widget and
		//	start the game.
		//////////////////////////////////////////////////////////////////////////
		void	GameScreenIsFinished();
		...
		void GetDefaultName(std::string& userName);
